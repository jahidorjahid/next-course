                  ...
                  <div className="row">
                    <div className="col-lg-4">
                      <ul className="pe-5">
                        ...
                        <li>
                          <a href="category.html">Finance &amp; Accounting</a>
                        </li>
                        <li>
                    ...
                    <div className="col-lg-4">
                      <ul className="pe-5">
                        <li>
                          <a href="category.html">Lifiestyle</a>
                        </li>
                        <li>
                    ...
                    <div className="col-lg-4">
                      <ul>
                        <li>
                          <a href="category.html">Customer Service</a>
                        </li>
                        <li>
                          <a href="category.html">Human Resources</a>
                        </li>
                        <li>
                          <a href="category.html">Leadership and Management</a>
                        </li>
                      </ul>
                    </div>
                  </div>
